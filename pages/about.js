    ...
    <section className="min-h-screen bg-black text-white px-4 pt-32 pb-20 animate-fade">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-300 mb-8">
          Pumpa Token is not just a memecoin. It’s a movement, a symbol of rebirth for those who’ve suffered in the volatile world of crypto. 
          Created from the ashes of financial despair, Pumpa gives everyone one last real shot — to rise again.
        </p>
